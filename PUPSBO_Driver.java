/*******************************************************************
*	Name              :	PUPSBO_Driver
*	Description       : Driver class for PUP-SBO LOB
*	Author            : ATS  
*	Date Created      :	
*	Modification Log  :                                                     
...
public class PUPSBO_Driver extends PupEN_ClassInvoker {	
    ...
    public void PUPSBO (TestContainer testContainer) throws Exception 
    {		
		try{ 	
DeviceWebDriver driver = getWebDriver();
			...
			CustomLoadDataElements.LoadData("PUPSBO",strDB,tcID, driver);
			...
			//Load PUPEN Repository
 			...
 			//Call to Cancel-Rewrite flow classes
