/*******************************************************************
*	Name              :	Mcycle_ENDriver
*	Description       : Driver class for Mcycle END LOB
*	Author            : ATS  
...
public class McycleEN_Driver extends McycleEN_ClassInvoker {	
	...
	public void McycleEN (TestContainer testContainer) throws Exception 
	//public void McycleEN (TestName testName, Device device) throws Exception
    {		
		try{ 	
			...
			CustomLoadDataElements.LoadData("McycleEN",strDB,tcID, driver);
			...
			//Load McycleEN Repository
 			...
 			String strEffDate=changeURLData.getData("EffectiveDate");					
