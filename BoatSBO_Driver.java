/*******************************************************************
*	Name              :	BoatSBO_Driver
*	Description       : Driver class for Boat-SBO LOB
*	Author            : ATS  
...
public class BoatSBO_Driver extends BoatEN_ClassInvoker {	
    ...
    public void BoatSBO (TestContainer testContainer) throws Exception 
    {		
		try{ 	
			...
			CustomLoadDataElements.LoadData("BoatSBO",strDB,tcID,driver);
...
//			CustomLoadDataElements.LoadRepository("ImpersonatePage");
			...
			impersonateMenu(changeURLData,"BoatEN");
			...
			if (AlliancePageKeywords.strSBOActivity.equals("CR")){
